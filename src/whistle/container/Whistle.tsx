    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.music}>
          <TouchableOpacity>
            <Icon name="skip-backward" onPress={() => BleManager.write("LAST")} size={100} color={Colors.secondary}/>
          </TouchableOpacity> 
          <TouchableOpacity>
            <Icon name={this.state.squetuveux?"pause":"play"} onPress={this.IsPlay} size={100} color={Colors.secondary}/>
          </TouchableOpacity>
          <TouchableOpacity>
            <Icon name="skip-forward" onPress={() => BleManager.write("NEXT")} size={100} color={Colors.secondary}/>
          </TouchableOpacity> 
        </View>
